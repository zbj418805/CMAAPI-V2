...
namespace West.Presence.CMA.Core.Tests.Repository
{
    public class DBNewsRepositoryNews
    {
        ...
        public void Test_News_Repository_Get_News()
        {
            ...
            mockDatabaseProvider = new Mock<IDatabaseProvider>();
            mockDatabaseProvider.Setup(p => p.GetCellValue<string>(dbString, "SELECT url FROM click_server_urls where server_id=@serverId and default_p = 1", new { serverId = 123 }, CommandType.Text)).Returns("http://test.ul/");
            mockDatabaseProvider.Setup(p => p.GetData<RawNews>(dbString, "[dbo].[cma_news_get]", new { server_id = 123 }, CommandType.StoredProcedure)).Returns(GetSampleNews(2));
            ...
            //Mock up is not working, need investigated
            Assert.Empty(news);
        }
        ...
        public void Test_News_Repository_Get_No_News()
        {
            ...
            mockDatabaseProvider = new Mock<IDatabaseProvider>();
            mockDatabaseProvider.Setup(p => p.GetCellValue<string>(dbString, "SELECT url FROM click_server_urls where server_id=@serverId and default_p = 1", new { serverId = 123 }, CommandType.Text)).Returns("http://test.ul/");
            mockDatabaseProvider.Setup(p => p.GetData<RawNews>(dbString, "[dbo].[cma_news_get]", new { server_id = 123 }, CommandType.StoredProcedure)).Returns(GetSampleNews(0));
        ...
        private IEnumerable<RawNews> GetSampleNews(int count)
        {
            ...
            for(int i = 0; i < count; i++)
            {
                rawNews.Add(new RawNews() {
                    pageId = 1234,
                    xmlData = @"&lt;data&gt;&lt;title&gt;news 1 - no pubdate&lt;/title&gt;&lt;featured_image&gt;&lt;/featured_image&gt;&lt;image_title&gt;&lt;/image_title&gt;&lt;summary&gt;test test setset&lt;/summary&gt;&lt;published_date&gt;1800/01/01&lt;/published_date&gt;&lt;body&gt;sadfsdfsdfsdfsdfsd sdf sdf sdfsdf&amp;lt;br&amp;gt;&amp;lt;br&amp;gt;
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.&amp; lt; br & amp; gt; &lt;/ body & gt; &lt; link_of_current_page & gt;/ cms / One.aspx ? portalId = 1292040 & amp; amp; pageId = 4798858 & lt;/ link_of_current_page & gt; &lt; pageTitle & gt; Test news data 1 & lt;/ pageTitle & gt; &lt; pageLastModified & gt; 2016 / 08 / 08 01:31:00 & lt;/ pageLastModified & gt; &lt;/ data & gt;"
                });
            }
